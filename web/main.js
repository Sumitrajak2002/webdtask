...
function inputhandler(event) {
  ...
  mappedarray = data.filter((item) =>
    item.description.toLowerCase().includes(strings.toLowerCase())
  );
  console.log(event);
...
function loadProducts(data) {
  ...
  li.innerHTML =
 ' <div class="card-container "><div class=" align-items-center  image-container text-center"> <img src="' +
 data.images[0] +
 '" class="rounded" width="150" height="100"></div>'+
'<h2 class="pr-h2">'+data.title+'</h2>'+
'<p class="pr-p">'+data.description +' </p>'+
' <h3 class="pr-h3"></h3>'+
' <h4 class="pr-h4">'+data.price+'</h4>'+
' <h4 style="color:green;" class="pr-discount">(12% off)</h4>'+
' <a href="#" class="buy">BUY NOW</a>'+
'</div>'
  document.getElementById("home_product").appendChild(li);
  console.log(document.getElementById("home_product"))
}
